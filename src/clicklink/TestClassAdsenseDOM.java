 ...
 */
public class TestClassAdsenseDOM {
    
        public static WebDriverWait wait;
        public static WebDriver driver;
        public PrintWriter writer;
        public TestClassAdsenseDOM()
        {
        ...
        driver.get("http://www.darkreading.com/");
        By by = By.id("header-full");
...
element = driver.findElement(By.id("header-full"));
            } catch (Exception e) {
